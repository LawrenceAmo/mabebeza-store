...
<x-guest-layout> 
    ...
    <div class="p-5 m-lg-5">
        <p class="mt-5"><strong>Terms and Conditions</strong></p>
        <p>Our Terms and Conditions were last updated on 10 April 2023.</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>"Website"</strong> refers to Fadaeco, accessible from
              <a href="fadaeco.com">fadaeco.com</a>
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          ...
          copyright agent via email info@amomad.com and include in Your notice a
        ...
        <p>
          ...
          <a href="mailto:info@amomad.com">info@amomad.com</a> ). Upon receipt of
        ...
        <ul>
          <li>
            ...
            <a href="/contact.html">fadaeco.com</a>
          </li>
          <li>
            By sending us an email:
            <a href="mailto:info@fadaeco.com">info@fadaeco.com</a>
          </li>
        </ul>
        <p></p>
      </div>
